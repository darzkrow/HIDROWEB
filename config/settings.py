...
# Ajusta la URL de Redis según tu configuración
CACHES = {
    "default": {
        ...
        "KEY_PREFIX": "consultas_nic",  # Prefijo para las claves de caché
    }
}
# Tiempo de expiración de la caché en segundos (20 minutos = 1200 segundos)
CACHE_TTL = 1200
